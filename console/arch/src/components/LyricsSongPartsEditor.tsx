    ...
    return (
      <div className="grid min-w-0 grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
        <section className="flex min-w-0 flex-col gap-3" aria-labelledby={`${fieldIdPrefix}-parts-heading`}>
              ...
              return [
                ...
                >
                  ...
                  <div className="mt-2 flex justify-end">
                    <button
                      type="button"
                      className="rounded-md px-2 py-1 text-[10px] font-medium text-red-700 transition outline-none hover:bg-red-500/10 focus-visible:ring-2 focus-visible:ring-red-500/40 disabled:cursor-not-allowed disabled:opacity-40 dark:text-red-300 dark:hover:bg-red-500/15 dark:focus-visible:ring-red-400/40"
                      onClick={() => {
          ...
          <button
            type="button"
            className="w-full rounded-lg border border-dashed border-black/[0.14] py-2 text-[11px] font-medium text-neutral-700 transition outline-none hover:bg-white focus-visible:ring-2 focus-visible:ring-[#0071e3] dark:border-white/[0.18] dark:text-neutral-200 dark:hover:bg-white/[0.06] dark:focus-visible:ring-[#0a84ff]"
        ...
        <section
          className="flex min-w-0 flex-col gap-5 border-t border-black/[0.06] pt-6 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-8 dark:border-white/[0.08]"
          ...
          <div>
            ...
            >
              ...
              <div
                ...
                className="flex min-h-10 w-full min-w-0 flex-wrap content-center items-center gap-2"
          ...
          return [
            ...
            >
              ...
              <div className="mt-2 flex flex-wrap items-center gap-1.5">
                <button
                  type="button"
                  className="rounded-md border border-black/[0.1] bg-white px-2 py-1 text-[10px] font-medium text-neutral-800 transition outline-none hover:bg-neutral-50 focus-visible:ring-2 focus-visible:ring-[#0071e3] disabled:cursor-not-allowed disabled:opacity-40 dark:border-white/[0.12] dark:bg-[#2c2c2e] dark:text-neutral-100 dark:hover:bg-white/5 dark:focus-visible:ring-[#0a84ff]"
                  onClick={() => {
                ...
                <button
                  type="button"
                  className="ml-auto rounded-md px-2 py-1 text-[10px] font-medium text-red-700 transition outline-none hover:bg-red-500/10 focus-visible:ring-2 focus-visible:ring-red-500/40 disabled:cursor-not-allowed disabled:opacity-40 dark:text-red-300 dark:hover:bg-red-500/15 dark:focus-visible:ring-red-400/40"
                  onClick={() => {
                    handleRemoveLine(index)
                  }}
                  disabled={lines.length <= MIN_LYRIC_PART_COUNT}
