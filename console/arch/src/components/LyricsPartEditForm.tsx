...
export const LyricsPartEditForm = forwardRef<HTMLElement, LyricsPartEditFormProps>(function LyricsPartEditForm(
  ...
  return (
    <aside
      ref={ref}
      className="flex max-h-[45vh] w-full shrink-0 flex-col overflow-hidden border-t border-neutral-200/90 bg-white sm:h-full sm:max-h-none sm:w-[min(100%,18rem)] sm:rounded-2xl sm:border-t-0 sm:border-l sm:border-black/[0.06] dark:border-white/[0.08] dark:bg-[#1c1c1e] sm:dark:border-white/[0.08]"
        ...
        {emptyStateMessage !== null ? (
          ...
          <div className="flex min-w-0 flex-col gap-4">
            ...
            <div>
                  ...
                  return (
                    ...
                    >
                      <div className="mb-2 flex justify-end">
                        <span
                          className={`rounded-full px-2 py-0.5 text-[10px] leading-none font-semibold ${statusBadgeClass}`}
                        >
              ...
              <button
                type="button"
                className="mt-2 w-full rounded-lg border border-dashed border-black/[0.14] py-2 text-[11px] font-medium text-neutral-700 transition outline-none hover:bg-white focus-visible:ring-2 focus-visible:ring-[#0071e3] dark:border-white/[0.18] dark:text-neutral-200 dark:hover:bg-white/[0.06] dark:focus-visible:ring-[#0a84ff]"
