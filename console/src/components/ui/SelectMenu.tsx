    ...
    <div className={cn('w-full', className)}>
      <DropdownMenu>
        <DropdownMenuTrigger
          ...
          className={cn(
            'border-input bg-background text-foreground inline-flex w-full items-center justify-between rounded-lg border text-left transition-[color,box-shadow] outline-none',
        ...
        <DropdownMenuContent
          align="start"
          sideOffset={6}
          className={cn('max-h-60 min-w-(--radix-dropdown-menu-trigger-width) overflow-y-auto p-1', contentClassName)}
        >
