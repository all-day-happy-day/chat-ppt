  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        <h2 className="text-[18px] font-semibold tracking-tight">Delete project?</h2>
        <p className="text-[14px] leading-relaxed text-neutral-600 dark:text-neutral-400">
          <span className="font-medium text-neutral-800 dark:text-neutral-200">{projectName}</span>
          <span className="text-neutral-600 dark:text-neutral-400"> — {PROJECT_DELETE_BODY_INTRO}</span>
        </p>
        <div className="flex flex-col gap-2">
          <p className="text-[13px] font-medium text-neutral-700 dark:text-neutral-300">Type the following code to confirm:</p>
          <p
          ...
          <input
            id={confirmInputId}
            name="project-delete-confirm-code"
            type="text"
            autoComplete="off"
            spellCheck={false}
        ...
        <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:justify-end">
          ...
          <button
            type="button"
            className="flex h-11 items-center justify-center rounded-xl bg-red-600 px-5 text-[15px] font-medium text-white transition hover:bg-red-700 active:bg-red-800 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-red-600 dark:hover:bg-red-500 dark:active:bg-red-700"
